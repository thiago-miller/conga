...
config_print_usage (FILE *fp)
{
	fprintf (fp,
		...
		"                        or a custom rule in BxSy format.\n"
		...
		"  into stable forms.\n"
		"\n"
		"2. Custom rules in BxSy format:\n"
		"\n"
		"This format explicitly defines birth (B) and survival (S)\n"
		"conditions.\n"
		"\n"
		"For example:\n"
		"B3S23   - Classic Conway’s rule: born with 3 neighbors,\n"
		"          survives with 2 or 3\n"
		"S23B3   - Same as above (order and case are ignored)\n"
		"B36S23  - Highlife rule\n"
		"\n"
